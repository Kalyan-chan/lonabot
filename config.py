...
# Токен бота (установите через переменную окружения или напрямую)
...
UPDATES_CHECK_INTERVAL = 1800  # 30 минут в секундах

UPDATES_CHAT_ID = -1003790930801  # Добавляем -100 перед ID
UPDATES_THREAD_ID = 53  # ID темы
